-- ============================================================================
-- Story of Emergence: Ensure reflection_sources table exists
-- This migration ensures the table is created if it doesn't exist
-- Run this in Supabase SQL Editor if migration 012 wasn't applied
-- ============================================================================

-- Enable pgcrypto extension if not already enabled
CREATE EXTENSION IF NOT EXISTS pgcrypto;

-- Create the reflection_sources table if it doesn't exist
-- Note: Uses user_wallet to match the codebase (not wallet_address)
