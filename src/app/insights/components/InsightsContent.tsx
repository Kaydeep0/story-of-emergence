...
import { InsightDrawer, normalizeInsight, type NormalizedInsight } from './InsightDrawer';
import { SummaryStatsSkeleton, InsightCardSkeleton, TimelineSectionSkeleton, SummaryStatsGridSkeleton } from './InsightsSkeleton';
...
export default function InsightsContent({ mode }: InsightsContentProps) {
